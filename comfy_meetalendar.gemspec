...
Gem::Specification.new do |s|
  ...
  s.authors     = ["Andreas Schau", "Andreas Reischuck"]
  s.email       = ["contact@hicknhack-software.com"]
  s.homepage    = "https://github.com/hicknhack-software/meetalendar"
  s.summary     = "To have a section on a comfy website that allows gathering of meetup groups. So that their events can regularly be synchronized into a google calendar."
  s.description = "This gem is a Comfortable-Mexican-Sofa Add-On and presents all the needed functionality to search for relevant groups on meetup, remember the chosen ones and offers a task that can be called regularly to transcribe the meetup-groups events to a google calendar. TLDR: It allows the user to subscribe to meetup-groups events."
  s.license     = "MIT"
